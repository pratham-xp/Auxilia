...
$dgDonations = new C_DataGrid("SELECT * FROM donation_furniture WHERE donorid='{$_SESSION["useruid"]}'", "donorid", "donation_furniture");
...
$dgDonations->set_col_title("furniture_type", "Furniture Type");
$dgDonations->set_col_title("furniture_location", "Pickup Location");
