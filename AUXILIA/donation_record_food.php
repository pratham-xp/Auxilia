...
$dgDonations = new C_DataGrid("SELECT * FROM donation_food WHERE donorid='{$_SESSION["useruid"]}'", "donorid", "donation_food");
...
$dgDonations->set_col_title("foodtype", "Food Type");
$dgDonations->set_col_title("quantity", "Quantity");
$dgDonations->set_col_title("expirydate", "Expiry Date");
$dgDonations->set_col_title("food_location", "Pickup Location");
